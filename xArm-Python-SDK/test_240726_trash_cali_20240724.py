...
class YOLOMain:
    def __init__(self, robot_main):
        ...
        self.rois = [(455, 65, 95, 95), (360, 65, 95, 95), (265, 65, 95, 95)]  # A_ZONE, B_ZONE, C_ZONE 순서
        self.max_roi_index=0
        # 카메라 열기
...
##1234
    ...
    def mog2(self, image_path1, image_path2):
        ...
        # 이미지 로드
        image1 = cv2.imread('/home/pjh/Downloads/chboon/capture_20240715_231221.jpg')
        ...
        while True:
            ...
            for box, mask, class_id, prob in zip(boxes, masks, cls, probs):  # 각 객체에 대해
                ...
                if label == 'capsule':  # 'capsule' 객체에 대해서만 중심 좌표 계산 및 출력
                    ...
                    if self.last_cup_center is not None:
                        if (self.center_x_mm is not None and self.center_y_mm is not None and 
                            ...
                            if self.start_time is None and self.robot.MODE == "ready":
                ...
                if label == 'capsule':  # capsule 객체만 확인
                    for i, (rx, ry, rw, rh) in enumerate(self.rois[:3]):  # 최대 세 개의 ROI만 확인
